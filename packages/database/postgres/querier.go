...
type Querier interface {
	...
	CreateAuthWebAuthnCredential(ctx context.Context, arg CreateAuthWebAuthnCredentialParams) (AuthWebauthnCredential, error)
	CreateAuthWebAuthnSession(ctx context.Context, arg CreateAuthWebAuthnSessionParams) (AuthWebauthnSession, error)
	...
	GetAuthWebAuthnSessionByID(ctx context.Context, id pgtype.UUID) (AuthWebauthnSession, error)
	...
	ListAuthWebAuthnCredentialsByUserID(ctx context.Context, userID pgtype.UUID) ([]AuthWebauthnCredential, error)
	...
	SetUserWebAuthnHandle(ctx context.Context, arg SetUserWebAuthnHandleParams) (User, error)
	TouchAPIKeyLastUsed(ctx context.Context, id pgtype.UUID) (ApiKey, error)
	UpdateAuthWebAuthnCredential(ctx context.Context, arg UpdateAuthWebAuthnCredentialParams) (AuthWebauthnCredential, error)
